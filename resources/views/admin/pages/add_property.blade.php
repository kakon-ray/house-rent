    ...
    <div class="card p-2">
      ...
      <form method="POST" action="/dashboard/add-rent-house/submit" enctype="multipart/form-data">
        ...
        <div class="my-4">
          ...
          <input type="text" class="form-control" name="amount" required autofocus placeholder="House Amount">
        </div>

        <div class="my-4">
          <label class="form-label"><b>Contact Number</b></label>
          <input type="text" class="form-control" name="number" required autofocus placeholder="House Amount">
        </div>

        <div class="my-4">
          <label class="form-label"><b>Rent Month</b></label>
          <input type="date" class="form-control" name="rent_month" required autofocus placeholder="House Time">
        </div>

        <div class="my-4">
          <label class="form-label"><b>House Location</b></label>
          <input type="text" class="form-control" name="house_location" autofocus placeholder="House Time">
        </div>

        <div class="my-4">
          <label class="form-label"><b>House Size</b></label>
          <input type="text" class="form-control" name="size" autofocus placeholder="House Time">
        </div>

        <div class="my-4">
          <label class="form-label"><b>Room</b></label>
          <input type="number" class="form-control" name="room" required autofocus placeholder="House Time">
        </div>

        <div class="my-4">
          <label class="form-label"><b>Bath Room</b></label>
          <input type="number" class="form-control" name="bath_room" required autofocus placeholder="House Time">
        </div>

        <div class="my-4">
          <label class="form-label"><b>Kitchen Room</b></label>
          <input type="number" class="form-control" name="kitchen_room" required autofocus placeholder="House Time">
        </div>
